...
public class ServerList {
     ...
     * 服务名->可用服务提供者列表
     */
    private HashMap<String, LoadBalance> map = new HashMap();

    private CuratorToClient curator;

    private LoadBalance loadingAlgorithm;


    public ServerList(RpcClientProperties clientConfig) {
     ...
     * @return IP:PORT
     */
    public String getProvider(String service, MessageBody message) {
        LoadBalance providers = map.get(service);
